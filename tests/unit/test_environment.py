"""Tests for the GRAIL environment module.
...
def test_loader_returns_gsm8k_instance():
    ...
    from grail.environment.gsm8k import GSM8KEnvironment
...
from grail.environment.gsm8k import _compute_gsm8k_reward  # noqa: E402 — after skippable imports
